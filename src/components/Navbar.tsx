export function NavBar() {
    return (
        <header className="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full h-[55px] border-b border-gray-200 text-sm py-3 sm:py-0 bg-[#272E71] dark:border-gray-700">
            <nav
                            ...
                            <div className="w-full box-border h-[30px] relative">
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center pointer-events-none pr-3">
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <g clip-path="url(#clip0_12987_1324)">
                                            <path
                        ...
                        <div className="flex-auto">
                            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-4 sm:mt-0 sm:pl-2">
                                ...
                                >
                                    ...
                                    <div className="">
                                        <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            <g clip-path="url(#clip0_12987_1327)">
                                                <path
                                ...
                                <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
                                    <button
                                        type="button"
                                        className="flex items-center w-full text-white hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500 "
                                    >
                                        EN
                                        <svg
                                ...
                                <a className="font-medium text-white hover:text-gray-400 sm:py-6" href="#">
                                    ...
                                    <div className="">
                                        <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            <g clip-path="url(#clip0_12987_1332)">
                                                <path
