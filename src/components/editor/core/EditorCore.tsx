...
import { SerializeEditorStateToHtmlPlugin } from "../plugins/SerializeEditorStateToHtmlPlugin";
...
export function EditorCore(props: EditorProps) {
    return (
        <LexicalComposer initialConfig={props.config}>
            ...
            <SerializeEditorStateToHtmlPlugin onCompleted={props.onSerializeComplete} />
            <ClearEditorPlugin />
        </LexicalComposer>
    );
}
